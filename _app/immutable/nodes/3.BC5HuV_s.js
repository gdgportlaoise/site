import{s as r,n as i}from"../chunks/scheduler.Ce_0Mfso.js";import{S as s,i as l,e as c,c as d,g as h,b as p,f as u,h as m}from"../chunks/index.Ch1nhLbS.js";function y(a){let e,o=`<h1 class="text-2xl">Code of Conduct &amp; Anti-Harrassment Policy</h1> <p>GDG Portlaoise is dedicated to providing a harassment-free and inclusive event experience for
		...
		Portlaoise takes violations of our policy seriously and will respond appropriately.
		<br/> <br/>
		All participants of GDG Portlaoise community &amp; events must abide by the following policy:
		<br/> <br/></p> <ol><li>Be excellent to each other. <br/>We want the event to be an excellent experience for everyone
			...
			would feel if it were said to or about you.</li> <li>2. Speak up if you see or hear something.<br/> Harassment is not tolerated, and you are empowered
			...
			is being harassed, or have any other concerns, please contact a member of the event staff immediately.</li> <li>3. Harassment is not tolerated.<br/> Harassment includes, but is not limited to: verbal language
			...
			Participants asked to stop any harassing behavior are expected to comply immediately.</li> <li>Practice saying &quot;Yes and&quot; to each other.<br/>
			It’s a theatre improv technique to build on each other’s ideas. We all benefit when we create together.</li></ol> <br/> <br/> <p>This policy extends to talks, forums, workshops, codelabs, social media, parties, hallway
		...
		and Anti-Harassment Policy and respond appropriately. Please note, while we take all concerns raised
		seriously, we will use our discretion as to determining when and how to follow up on reported incidents,
		and may decline to take any further action and/or may direct the participant to other resources for
		resolution.
		<br/> <br/>
		Event staff will be happy to help participants contact hotel/venue security or local law enforcement,
		provide escorts, or otherwise assist those experiencing discomfort or harassment to feel safe for
		the duration of the event. We value your attendance.
		<br/> <br/>
		Exhibiting partners, sponsors or vendor booths, or similar activities are also subject to this policy.
		In particular, exhibitors should not use sexualized images, activities, or other material. Booth
		staff (including volunteers) should not use sexualized clothing/uniforms/costumes, or otherwise create
		a sexualized environment. Participants and exhibiting partners or sponsors disobeying this policy
		will be notified and are expected to stop any offending behavior immediately.
		<br/> <br/></p> <h3 class="text-lg">Why this policy is important</h3> <p><br/>
		Harassment at events and in online communities is unfortunately common. Creating an official policy
		aims to improve this by making it clear that harassment of anyone for any reason is not acceptable
		within our events and communities. This policy may prevent harassment by clearly defining expectations
		for behavior, aims to provide reassurance, and encourages people who have had bad experiences at
		other events to participate in this one.
		<br/> <br/></p> <h4>Licence and Attribution</h4> <p><br/> <br/>
		This policy is licensed under the Creative Commons Zero license.
		<br/> <br/>
		This policy is based on and influenced by several other community policies including: Ohio LinuxFest
		Anti-Harassment policy, Con Anti-Harassment Project, Geek Feminism Wiki (created by the Ada Initiative),
		ConfCodeofConduct.com, JSconf, Rust, Diversity in Python, and Write/Speak/Code.</p>`;return{c(){e=c("div"),e.innerHTML=o,this.h()},l(t){e=d(t,"DIV",{class:!0,"data-svelte-h":!0}),h(e)!=="svelte-1aobzwc"&&(e.innerHTML=o),this.h()},h(){p(e,"class","container mx-auto")},m(t,n){u(t,e,n)},p:i,i,o:i,d(t){t&&m(e)}}}class b extends s{constructor(e){super(),l(this,e,null,y,r,{})}}export{b as component};
