import{s as r,n as i}from"../chunks/scheduler.Dw93JyHj.js";import{S as s,i as l,e as c,c as d,g as h,b as p,f as u,h as m}from"../chunks/index.CpCNWAsF.js";function y(a){let e,o=`<h1 class="text-3xl">Code of Conduct &amp; Anti-Harrassment Policy</h1> <br/> <p>GDG Portlaoise is dedicated to providing a harassment-free and inclusive event experience for
		...
		<br/> <br/></p> <ol><li>1. Be excellent to each other.
			<br/> <br/>
			...
			feel if it were said to or about you.</li> <br/> <li>2. Speak up if you see or hear something.
			<br/> <br/>
			...
			a member of the event staff immediately.</li> <br/> <li>3. Harassment is not tolerated.
			<br/> <br/>
			...
			harassing behavior are expected to comply immediately.</li> <br/> <li>4.Practice saying &quot;Yes and&quot; to each other.
			<br/> <br/>
			It’s a theatre improv technique to build on each other’s ideas. We all benefit when we create together.</li></ol> <br/> <p>This policy extends to talks, forums, workshops, codelabs, social media, parties, hallway
		...
		ConfCodeofConduct.com, JSconf, Rust, Diversity in Python, and Write/Speak/Code.</p>`;return{c(){e=c("div"),e.innerHTML=o,this.h()},l(t){e=d(t,"DIV",{class:!0,"data-svelte-h":!0}),h(e)!=="svelte-1qx64tt"&&(e.innerHTML=o),this.h()},h(){p(e,"class","container mx-auto my-10")},m(t,n){u(t,e,n)},p:i,i,o:i,d(t){t&&m(e)}}}class g extends s{constructor(e){super(),l(this,e,null,y,r,{})}}export{g as component};
